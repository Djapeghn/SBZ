...
public class Pacijent {
	...
	public Pacijent(String ime, String prezime, Date datumRodjenja, String pol, ArrayList<Pregled> pregledi,
			ArrayList<Bolest> bolesti, ArrayList<Lek> alergicanNaLekove) {
		super();
		this.ime = ime;
